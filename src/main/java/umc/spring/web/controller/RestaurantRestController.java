...
public class RestaurantRestController {
    ...
    public ApiResponse<ReviewResponseDTO.ReviewPreViewListDTO> getReviewList(@ExistRestraurant @PathVariable(name = "restaurantId") Long storeId, @RequestParam(name = "page") Integer page){
